  ...
  static defineSchema() {
    ...
    return {
      ...
      statusBars: new fields.SchemaField({
        condition: new fields.SchemaField({ value: new fields.NumberField({initial: 0}), max: new fields.NumberField({initial: 0}) }),
        matrix: new fields.SchemaField({ value: new fields.NumberField({initial: 0}), max: new fields.NumberField({initial: 0}) }),
      }),
      defenses: new fields.SchemaField({
        ...
        ramming: new fields.SchemaField({
          ...
          modifiers: new fields.ArrayField(new fields.ObjectField()),
          limit: new fields.SchemaField({
            base: new fields.StringField({initial: 'handling'}),
            value: new fields.NumberField({initial: 0}),
            modifiers: new fields.ArrayField(new fields.ObjectField()),
          }),
        }),
      ...
      skills: new fields.SchemaField({
        perception: new fields.SchemaField({
          ...
          test: dicePoolSchema(),
          linkedAttribute: new fields.StringField({initial: 'pilot'}),
          limit: new fields.SchemaField({ value: new fields.NumberField({initial: 0}), base: new fields.StringField({initial: 'sensor'}), modifiers: new fields.ArrayField(new fields.ObjectField()) }),
          skillGroup: new fields.StringField({initial: ''}),
          category: new fields.StringField({initial: 'physicalSkills'}),
          canDefault: new fields.BooleanField({initial: true}),
          specializations: new fields.StringField({initial: ''}),
          perceptionType: new fields.SchemaField({
            sight: new fields.SchemaField({
              test: dicePoolSchema(),
              limit: new fields.SchemaField({ value: new fields.NumberField({initial: 0}), base: new fields.StringField({initial: 'mentalLimit'}), modifiers: new fields.ArrayField(new fields.ObjectField()) }),
            }),
        ...
        sneaking: new fields.SchemaField({
          ...
          test: dicePoolSchema(),
          linkedAttribute: new fields.StringField({initial: 'pilot'}),
          limit: new fields.SchemaField({ value: new fields.NumberField({initial: 0}), base: new fields.StringField({initial: 'handling'}), modifiers: new fields.ArrayField(new fields.ObjectField()) }),
          skillGroup: new fields.StringField({initial: ''}),
          category: new fields.StringField({initial: 'physicalSkills'}),
          canDefault: new fields.BooleanField({initial: true}),
          specializations: new fields.StringField({initial: ''}),
      ...
      secondaryPropulsionType: new fields.StringField({initial: ''}),
      isSecondaryPropulsionActivate: new fields.BooleanField({initial: false}),
      ...
      modificationSlots: new fields.SchemaField({
        powerTrain: new fields.SchemaField({ ...sr5ModsPartialModel.defineSchema() }),
        protection: new fields.SchemaField({ ...sr5ModsPartialModel.defineSchema() }),
        weapons: new fields.SchemaField({ ...sr5ModsPartialModel.defineSchema() }),
        body: new fields.SchemaField({ ...sr5ModsPartialModel.defineSchema() }),
        electromagnetic: new fields.SchemaField({ ...sr5ModsPartialModel.defineSchema() }),
        cosmetic: new fields.SchemaField({ ...sr5ModsPartialModel.defineSchema() }),
      ...
      vehicleTest: new fields.SchemaField({
        ...
        limit: new fields.SchemaField({
          ...
          value: new fields.NumberField({initial: 0}),
          modifiers: new fields.ArrayField(new fields.ObjectField()),
          linkedAttribute: new fields.StringField({initial: 'handling'}),
        }),
        test: dicePoolSchema(),
      }),
      ...
      passiveTargeting: new fields.BooleanField({initial: false}),
