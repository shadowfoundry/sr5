...
export class sr5ItemSpellDataModel extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    ...
    return {
      ...
      casterMagic: new fields.NumberField({
        initial: 0
      }),
      spellAreaOfEffect: new fields.SchemaField({
        ...sr5ModsPartialModel.defineSchema()
      }),
      spellAreaExtended: new fields.BooleanField({
        initial: false
      }),
      hits: new fields.NumberField({
        initial: 0
      }),
      manipulationDamaging: new fields.BooleanField({
        initial: false
      }),
      ...
      healthEssence: new fields.BooleanField({
        initial: false
      }),
      freeSustain: new fields.BooleanField({
        initial: false
      }),
      preparation: new fields.BooleanField({
        initial: false
      }),
      ...
      karmaSpent: new fields.NumberField({
        initial: 0
      }),
    }
  }
