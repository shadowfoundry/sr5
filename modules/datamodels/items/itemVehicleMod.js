...
export class sr5ItemVehicleModDataModel extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    ...
    return {
      ...
      isWeaponMounted: new fields.BooleanField({initial: false}),
      weaponMount: new fields.SchemaField({
        size: new fields.StringField({initial: ''}),
        visibility: new fields.StringField({initial: ''}),
        flexibility: new fields.StringField({initial: ''}),
        control: new fields.StringField({initial: ''}),
      }),
      weaponChoices: new fields.ArrayField(new fields.ObjectField()),
      mountedWeapon: new fields.StringField({initial: ''}),
      mountedWeaponName: new fields.StringField({initial: ''}),
      ...
      vehiclePriceMultiplier: new fields.SchemaField({
        ...
        vehicle: new fields.NumberField({initial: 0}),
      }),
    }
  }
}
