...
export default function calledShotStunned(rollData, actor, chatData){
  ...
  //Determine title
  rollData.test.title = `${game.i18n.format('SR5.EffectResistanceTest', {
    effect: game.i18n.localize(SR5.calledShotsEffects[calledShotEffect.name])
  })} (${calledShotEffect.threshold})`
