#!/usr/bin/env node
// Prepares a new release: bumps version in system.json and package.json,
...
bumpVersion(path.join(ROOT, 'system.json'))
...
// --- Commit ---
execSync('git add system.json package.json package-lock.json', { cwd: ROOT })
