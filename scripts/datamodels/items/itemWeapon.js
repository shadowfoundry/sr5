  ...
  static defineSchema() {
    ...
    return {
      ...
      firingMode: new fields.SchemaField({
        singleShot: new fields.BooleanField({initial: false}),
        semiAutomatic: new fields.BooleanField({initial: false}),
        burstFire: new fields.BooleanField({initial: false}),
        fullyAutomatic: new fields.BooleanField({initial: false}),
        value: new fields.ArrayField(new fields.StringField()),
        current: new fields.StringField({initial: ''}),
      }),
      ...
      ammunition: new fields.SchemaField({
        ...
        type: new fields.StringField({initial: ''}),
        casing: new fields.StringField({initial: ''}),
      ...
      toxin: new fields.SchemaField({
        ...
        vector: new fields.SchemaField({
          ...
          ingestion: new fields.BooleanField({initial: false}),
          inhalation: new fields.BooleanField({initial: false}),
          injection: new fields.BooleanField({initial: false}),
        }),
        speed: new fields.StringField({initial: ''}),
        power: new fields.NumberField({initial: 0}),
        effect: new fields.SchemaField({
          disorientation: new fields.BooleanField({initial: false}),
          nausea: new fields.BooleanField({initial: false}),
          paralysis: new fields.BooleanField({initial: false}),
          agony: new fields.BooleanField({initial: false}),
          arcaneInhibitor: new fields.BooleanField({initial: false}),
        }),
        penetration: new fields.NumberField({initial: 0}),
        damageType: new fields.StringField({nullable: true, initial: null}),
      }),
      isLinkedToFocus: new fields.BooleanField({initial: false}),
      isUsedAsFocus: new fields.BooleanField({initial: false}),
