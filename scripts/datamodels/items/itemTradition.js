...
export class sr5ItemTraditionDataModel extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    ...
    return {
      ...
      drainAttribute: new fields.StringField({initial: ''}),
      spiritCombat: new fields.StringField({initial: ''}),
      spiritDetection: new fields.StringField({initial: ''}),
      spiritIllusion: new fields.StringField({initial: ''}),
      spiritManipulation: new fields.StringField({initial: ''}),
      spiritHealth: new fields.StringField({initial: ''}),
