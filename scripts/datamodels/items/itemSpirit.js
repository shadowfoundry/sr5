...
export class sr5ItemSpiritDataModel extends foundry.abstract.TypeDataModel {
  static defineSchema() {
    ...
    return {
      ...
      isBounded: new fields.BooleanField({initial: false}),
      magic: new fields.SchemaField({
        tradition: new fields.StringField({initial: ''}),
        magicType: new fields.StringField({initial: 'spirit'}),
      ...
      summonerMagic: new fields.NumberField({initial: 0}),
      ...
      attributes: new fields.SchemaField({
        ...
        logic: new fields.NumberField({initial: 0}),
        intuition: new fields.NumberField({initial: 0}),
        charisma: new fields.NumberField({initial: 0}),
        essence: new fields.NumberField({initial: 0}),
        magic: new fields.NumberField({initial: 0}),
      }),
      ...
      spellType: new fields.StringField({initial: ''}),
    }
  }
}
