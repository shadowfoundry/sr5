...
export default async function complexFormDefense(rollData, actor, chatData){
    ...
    let actorData = actor.system,
        ...
        complexFormItem = await fromUuid(chatData.target.itemUuid);

    //Determine title
    rollData.test.title = `${game.i18n.localize("SR5.Defense")} ${game.i18n.localize("SR5.Against")} ${complexFormItem.name} (${chatData.hits})`;
